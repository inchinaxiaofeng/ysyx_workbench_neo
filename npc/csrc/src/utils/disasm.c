...
// void init_disasm() {
//   void *dl_handle;
//   dl_handle = dlopen("tools/capstone/repo/libcapstone." CS_LIB_SUFFIX,
//   RTLD_LAZY); assert(dl_handle);
//
...
//                    MUXDEF(CONFIG_ISA_loongarch32r,  CS_ARCH_LOONGARCH,
//                    -1))));
//   cs_mode mode = MUXDEF(CONFIG_ISA_x86,      CS_MODE_32,
//                    MUXDEF(CONFIG_ISA_mips32, CS_MODE_MIPS32,
//                    MUXDEF(CONFIG_ISA_riscv,  MUXDEF(CONFIG_ISA64,
//                    CS_MODE_RISCV64, CS_MODE_RISCV32) | CS_MODE_RISCVC,
//                    MUXDEF(CONFIG_ISA_loongarch32r,  CS_MODE_LOONGARCH32,
//                    -1))));
...
// { 	cs_insn *insn; 	size_t count = cs_disasm_dl(handle, code, nbyte, pc, 0,
// &insn);
//   assert(count == 1);
